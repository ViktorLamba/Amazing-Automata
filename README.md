...
Необходимо нажать на кнопку "Выбрать папку"

После этого появится вся структура проекта

Далее необходимо нажать на "Загрузить" и запустится скрипт билда
 ____
...
После успешной отработки необходимо прописать:
$ git push origin dev
